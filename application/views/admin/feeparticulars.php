						  ...
						  <!---------------------------------------->
                                ...
                                <label class="control-label">Fee Type</label>
										...
										<label class="radio inline">
											...
											<input type="radio" name="fee_type" id="type_0" value="0"  <?php  echo 'checked';   ?>> Others 
										</label>
										<label class="radio inline">
											<input type="radio" name="fee_type" id="type_1" value="1"  > School 
										</label>
										<label class="radio inline">
										<input type="radio" name="fee_type" id="type_2" value="2" > Traveling 
										</label>
										</div>
                                </div>
							<!----------------------------------------->
							<!----------------------------------------->
                                ...
                                <label class="control-label">Fee Applicable</label>
										...
										<?php /*<label class="radio inline">
											...
											<input type="radio" name="fee_applicble" id="type_0" value="0"  checked > All 
										</label>
										<label class="radio inline">
											<input type="radio" name="fee_applicble" id="type_1" value="1" > RTE  
										</label>
										<label class="radio inline">
										<input type="radio" name="fee_applicble" id="type_2" value="2" > Non-RTE 
										</label> */?>
										
										<label class="checkbox inline">
											<input type="checkbox" name="fee_applicble[]" id="type_1" value="1"  checked > RTE  
										</label>
										<label class="checkbox inline">
										<input type="checkbox" name="fee_applicble[]" id="type_2" value="2" checked > Non-RTE 
										</label>
										<label class="checkbox inline">
										<input type="checkbox" name="fee_applicble[]" id="type_3" value="3" checked > Staff Members
										</label>
