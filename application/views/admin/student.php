        ...
        <div class="box-content">
            ...
            <div class="tab-content">
               ...
               <div class="tab-pane <?php if(isset($upload)) { echo 'active'; } ?>" id="upload">
                   <?php echo $error;?>
           <?php echo form_open_multipart('admin/student/do_upload/',array('name' => 'myform1','id' => 'myform1')); ?>
...
<br />
No. of student in a class <?php echo $student_count; ?>
                        </center>

						 <?php echo form_open_multipart('admin/student/do_upload/',array('name' => 'myform2','id' => 'myform2')); ?>
    ...
    ?>
						 ...
						 <td valign="top"><input class="btn btn-green btn-small" type="button" value="Bulk Promote" name="bulk-promote1" onclick="$('#bulk-promote').val('Bulk Promote');$('#myform2').submit();">
						  
						   <input type="hidden" value="" id="bulk-promote" name="bulk-promote">
			...
			<?php /******************************************************************************************************/ ?>			 
						...
						<!--<input class="btn btn-green btn-small" type="button" value="Bulk SMS" name="bulk-sms" onclick="alert(1);">-->
						<a data-toggle="modal" href="javascript:;" class="btn btn-green btn-small custom-tam-indsudsms" data-studentid="1" data-stype="bulk-sms"><i class="icon-mobile-phone"></i> Bulk SMS </a>
...
<?php $j++ ?>
    ...
    <?php endif; ?>
                ...
                <div class="tab-pane box" id="add" style="padding: 5px">
                    ...
                    <div class="box-content">
    <?php echo form_open('admin/student/create/', array('class' => 'form-horizontal validatable', 'enctype' => 'multipart/form-data','name' => 'myform3','id' => 'myform3' )); ?>
						...
						<!-- <div class="control-group">
                           ...
                           <!-- <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="fill-up" name="passport_number" />
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="datepicker fill-up" name="date_of_issue"/>
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="datepicker fill-up" name="date_of_expiry"/>
                            ...
                            <!--<div class="control-group">
                                ...
                                <label class="control-label"><?php echo get_phrase('parent Username/email'); ?></label>
                           ...
                           <!-- <div class="control-group">
							...
							<!---------------------------------------->
                                ...
                                <label class="control-label">RTE</label>
										<div class="controls">
										<label class="radio inline">
											<input type="radio" name="rte" id="rte_yes" value="1"  > Yes
										</label>
										<label class="radio inline">
										<input type="radio" name="rte" id="rte_no" value="0" <?php  echo "checked" ?>> No
										</label>
										</div>
                                </div>
                                ...
                                <label class="control-label">Student category</label>
										<div class="controls">
										<label class="radio inline">
											<input type="radio" name="student_category" id="student_category_0" value="0"  <?php echo "checked";  ?>> Genral
										</label>
										<label class="radio inline">
										<input type="radio" name="student_category" id="student_category_1" value="1"> Staff
										</label>
										</div>
                                </div>
							<!----------------------------------------->
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="" name="aadhaar_number" value=""/>            
									</div> 
                                </div>
							<!----------------------------------------->
...
$('.custom-tam-indsudsms').on('click',function(e){
	...
	$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>index.php?admin/sms_student_data_all',
			data: { cid:$('select[name="class_id"').val() },
			success: function(data) {
...
$(document).on('click','#sndsmsbtnbulk',function(e){
	...
	$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>index.php?admin/sms_student_snd_all',
