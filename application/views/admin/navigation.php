...
<!--		<li class="<?php if($page_name == 'parent')echo 'dark-nav active';?>">
        ...
        <li class="dark-nav <?php if(	$page_name == 'feecategories' || $page_name == 'edit_fee_categories'   ||  $page_name == 'feeparticulars' || $page_name == 'edit_feeparticulars' ||  $page_name == 'feeperiods' ||  $page_name == 'feecollect' ||  $page_name == 'feereporting' ||  $page_name == 'edit_feeperiod')echo 'active';?>">
            ...
            <ul id="payment_submenu" class="collapse <?php if(	$page_name == 'feecategories' || $page_name == 'edit_fee_categories'  || $page_name == 'feeparticulars' || $page_name == 'edit_feeparticulars'||  $page_name == 'feeperiods' ||  $page_name == 'feecollect' ||  $page_name == 'feereporting' ||  $page_name == 'edit_feeperiod') echo 'in';?>">
                    ...
                    <li class="<?php if($page_name == 'feecollect')echo 'dark-nav active';?>">
					 ...
					 <!------Class wise fees----->
                    <li class="<?php if($page_name == 'feecollectall')echo 'dark-nav active';?>">
                        <span class="glow"></span>
                            <a href="<?php echo base_url();?>index.php?admin/feecollectall" rel="tooltip" data-placement="right" 
                                data-original-title="<?php echo get_phrase('fee_collect_all_help');?>">
								<i class="icon-user icon-plus"></i>  
                                <span><?php echo get_phrase('fee_collect_all');?></span>
                            </a>
                    </li>
					...
					<li class="<?php if($page_name == 'feereportingall')echo 'dark-nav active';?>">
                        <span class="glow"></span>
                            <a href="<?php echo base_url();?>index.php?admin/feereportingall" rel="tooltip" data-placement="right" 
                                data-original-title="<?php echo get_phrase('fee_reporting_all_help');?>">
								<i class="icon-user icon-plus"></i>  
                                <span><?php echo get_phrase('fee_reporting_all');?></span>
                            </a>
                    </li>
					
						<li class="<?php if($page_name == 'income_expences')echo 'dark-nav active';?>">
                        <span class="glow"></span>
                            <a href="<?php echo base_url();?>index.php?admin/income_expenses" rel="tooltip" data-placement="right" 
                                data-original-title="<?php echo get_phrase('income_expenses');?>">
								<i class="icon-user icon-plus"></i>  
                                <span><?php echo get_phrase('income_and_expenses');?></span>
                            </a>
                    </li>
		...
		<li class="dark-nav <?php if(	$page_name == 'book' ||  $page_name == 'bookcat' )echo 'active';?>">
       	...
       	<!------transport------>
		<li class="dark-nav <?php if(	$page_name == 'transport' ||  $page_name == 'dormitory' ||  $page_name == 'frontdeskenquiry' ||  $page_name == 'tasks_view' || $page_name == 'placements' )echo 'active';?>">
			<span class="glow"></span>
            ...
            <ul id="utilities_submenu" class="collapse <?php if(	$page_name == 'transport' ||  $page_name == 'dormitory' ||  $page_name == 'frontdeskenquiry' ||  $page_name == 'tasks_view' || $page_name == 'placements'   )echo 'in';?>">
