                ...
                <table border="0" cellspacing="0" cellpadding="0" class="table table-normal box">
                	...
                	<tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="daily_attendence_date" id="daily_attendence_date" class="datepicker fill-up" value="<?php if(isset($daily_attendence_date)) { echo date("d/m/Y",strtotime($daily_attendence_date)); } ?>">
...
<script src="<?php base_url() ?>template/js/jquery-1.11.1.min.js" type="text/javascript"></script>
