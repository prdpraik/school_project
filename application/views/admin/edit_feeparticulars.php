                        ...
                        <!---------------------------------------->
                                ...
                                <label class="control-label">Fee Type</label>
										...
										<label class="radio inline">
											...
											<input type="radio" name="fee_type" id="type_0" value="0"  <?php if($fee_type==0) { echo 'checked'; }  ?>> Others 
										</label>
										<label class="radio inline">
											<input type="radio" name="fee_type" id="type_1" value="1" <?php if($fee_type==1) { echo 'checked'; }  ?>  > School 
										</label>
										<label class="radio inline">
										<input type="radio" name="fee_type" id="type_2" value="2" <?php if($fee_type==2) { echo 'checked'; }  ?> > Traveling 
										</label>
										</div>
                                </div>
							<!----------------------------------------->
								 	<div class="control-group">
								<?php $array_applicable=explode(",",$fee_applicble);
									  if(in_array(0,$array_applicable)){
										  $array_applicable=array(1,2,3);
									  }

								?>
                                <label class="control-label">Fee Applicable</label>
										<div class="controls">
								
										<label class="checkbox inline">
											<input type="checkbox" name="fee_applicble[]" id="type_1" value="1" <?php if(in_array(1,$array_applicable)) { echo 'checked'; }  ?>  > RTE  
										</label>
										<label class="checkbox inline">
										<input type="checkbox" name="fee_applicble[]" id="type_2" value="2" <?php if(in_array(2,$array_applicable)) { echo 'checked'; }  ?> > Non-RTE 
										</label>
										<label class="checkbox inline">
										<input type="checkbox" name="fee_applicble[]" id="type_3" value="3" <?php if(in_array(3,$array_applicable)) { echo 'checked'; }  ?> > Staff Members
										</label>
										</div>
                                </div>
