	...
	<div class="navbar-inner" id="tam-custom-navbar-top">
		<div class="container-fluid">
			...
			<div class="nav-collapse nav-collapse-top collapse" id="custom-tam-profile-menu">
            	<ul class="nav pull-right">
					<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-user"></i> Hi, <?php echo get_phrase($this->session->userdata('name'));?> <?php //echo get_phrase('account');?> <b class="caret"></b></a>
					<!-- Account Selector -->
