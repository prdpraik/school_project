                    ...
                    <table class="table table-bordered">
                        ...
                        <?php
						 ...
						 ?>
                            ...
                            <?php } if($fp_payamount > 0) { ?>
                            <button class="btn btn-small btn-success custom-fee-pay-his-btn" name="payhisbutton" id="payhisbutton_<?php echo $i; ?>" value="" data-pay-his-id="<?php echo $i; ?>">View Pay History</button>
                            <?php } ?>
                        ...
                        <tr>
							 ...
							 echo  $fpayamount = ($fpamount - $fdisamount ) - ($fppaidamount);
							 ?>
                        	<td><?php echo $i; ?></td>
